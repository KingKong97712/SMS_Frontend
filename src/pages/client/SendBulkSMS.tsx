...
import { Send, Users, MessageSquare, Calendar, Clock, Target } from 'lucide-react';
...
export default function SendBulkSMS() {
  ...
  const groups: Group[] = [
    ...
    { id: '5', name: 'Mobile App Users', count: 12800, description: 'Active mobile application users' }
  ];
          ...
          <div className="relative z-10">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-emerald-100 text-lg">Send SMS to multiple groups at once</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <div className="text-3xl font-bold">{totalRecipients.toLocaleString()}</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <div className="text-3xl font-bold">${(0.05 * smsCount * totalRecipients).toFixed(2)}</div>
          ...
          <div className="xl:col-span-2 space-y-6">
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-emerald-50 rounded-3xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white">
                ...
                <CardDescription className="text-emerald-100">Choose which groups to send SMS to</CardDescription>
              </CardHeader>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center justify-between mb-2">
                            <h3 className="font-bold text-emerald-900">{group.name}</h3>
            ...
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-blue-50 rounded-3xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white">
                ...
                <CardDescription className="text-blue-100">Compose your bulk SMS message</CardDescription>
              </CardHeader>
              <CardContent className="p-6">
            ...
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-purple-50 rounded-3xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-purple-500 to-pink-500 text-white">
                ...
                <CardDescription className="text-purple-100">Choose when to send your messages</CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold text-purple-900">Send Now</div>
                          <div className="text-sm text-gray-600">Immediate delivery</div>
                        </div>
                      </div>
                    </div>
                    <div 
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold text-purple-900">Schedule</div>
                          <div className="text-sm text-gray-600">Send later</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-indigo-50 rounded-3xl overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white">
                ...
                <CardDescription className="text-indigo-100">Review and send your campaign</CardDescription>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 rounded-xl p-4">
                  <div className="text-sm text-amber-800">
                    ...
                    <div>Recipients: {totalRecipients.toLocaleString()}</div>
                    <div>SMS Parts: {(smsCount * totalRecipients).toLocaleString()}</div>
                    <div className="font-semibold">Total Cost: ${(0.05 * smsCount * totalRecipients).toFixed(2)}</div>
                  </div>
                </div>

                <Button 
                  onClick={handleSendBulkSMS}
                  disabled={selectedGroups.length === 0 || !message || !selectedSenderId || sending}
                ...
                >
                  {sending ? (
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>{scheduleType === 'now' ? 'Send Now' : 'Schedule SMS'}</span>
                    </div>
                  )}
                </Button>
              </CardContent>
